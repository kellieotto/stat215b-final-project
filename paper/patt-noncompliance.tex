...
\todo{clean up formatting. this is ugly}
...
where $L_j$ is the treatment and sample assignment vector for unit $j$. \end{assumption}
 This means that the treatment assignment for all other individuals $j$ does not affect the potential outcomes of individual $i$.
