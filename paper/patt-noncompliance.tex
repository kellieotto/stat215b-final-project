...
\todo{Devote a paragraph to this -- While we cannot directly test assumptions \eqref{si_treat}--\eqref{si_ctrl}, which imply that potential outcomes for treatment and control are independent of sample assignment for individuals with the same covariates $W$ and assignment to treatment, \citet{finkelstein2012} demonstrate strong ignorability in treatment assignment in the RCT sample.} \\
