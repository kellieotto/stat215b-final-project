...
Assumption \ref{monotonicity} does not hold due to the presence of compliers in the control group --- that is, participants who were assigned to control and enrolled in Medicaid during the study period. The violation of the monotonicity assumption does not appear to be appropriately addressed in \citet{finkelstein2012} nor any of the follow--up papers. We need to explore how double--crossover affects our PATT estimates in a future version of this paper. 
